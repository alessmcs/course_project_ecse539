...
<solution name="GSONSolution" uuid="0daa541f-ff0d-45e5-b308-dea7a9ccb64d" moduleVersion="0">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot path="${module}/models" />
    </modelRoot>
    <modelRoot contentPath="/Users/alessandramancas/Downloads/gson-main/gson/target/gson-2.13.3-SNAPSHOT.jar!/" type="java_classes">
      <sourceRoot location="." />
    </modelRoot>
  </models>
  <facets>
