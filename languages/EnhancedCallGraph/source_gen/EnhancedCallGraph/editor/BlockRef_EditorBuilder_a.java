...
/*package*/ class BlockRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BlockRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_bkazcz_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$ND_8;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.target$ND_8);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.target$ND_8);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createReferencePresentation_0() {
      ...
      editorCell.setCellId("ReferencePresentation_bkazcz_a0b0");
      return editorCell;
    }
  }
